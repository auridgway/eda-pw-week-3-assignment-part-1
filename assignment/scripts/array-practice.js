...
let favoriteFoods = ['potatoes', 'goldfish', 'sushi'];
...
console.log('Check for dessert: ', favoriteFoods);
...
console.log('Check for entree: ', favoriteFoods);
...
console.log('Colors Array: ', colors, 'Last color: ', lastColor);
...
console.log('Colors Array: ', colors, 'First color: ', firstColor);
...
console.log('Checking to see combined arrays: ',colorfulGems);
